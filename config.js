module.exports = {
  siteTitle: 'Green House Stereo', // <title>
  manifestName: 'Green House Stereo',
  ...
  subHeading3: 'The band is currently performing throughout the Black Hills.',
  // social
  socialLinks: [
    {
      icon: 'fa-map',
      name: 'Black Hills, SD',
      url: 'https://goo.gl/maps/tMuf9YVKiUxbyHLF9',
    },
    {
      icon: 'fa-twitter',
      name: 'Twitter',
      url: 'https://twitter.com/GHStereo',
    },
    {
      icon: 'fa-instagram',
      name: 'Instagram',
      url: 'https://www.instagram.com/greenhousestereo/',
    },
    {
      icon: 'fa-youtube',
      name: 'YouTube',
      url: 'https://www.youtube.com/channel/UCI8p8azpwSY9nMuFYXIc1xg',
    },
    {
      icon: 'fa-facebook',
      name: 'Facebook',
    ...
    },
    {
      icon: 'fa-envelope-o',
      name: 'Email',
      url: 'mailto:greenhousestereo@gmail.com',
    },
  ],
  phone: '000-00000',
  address: 'Black Hills, SD',
};
